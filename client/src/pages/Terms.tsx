        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-white rounded-2xl p-8 md:p-12">
            ...
            <div className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">1.1 What We Provide</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">1.2 Completion of Transaction</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">2.1 Storage Period</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">2.2 Privacy Commitment</h3>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">2.3 Data Protection</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">3.1 Ownership of Uploaded Content</h3>
              <p>You retain full ownership of all photos or content you upload to DILOO.</p>

              <h3 className="text-xl font-semibold text-black mt-6 mb-3">3.2 License to Generated Images</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">3.3 Prohibited Uses</h3>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">4.1 Refund Window</h3>
              <p>You may request a refund within <strong>7 days</strong> of your purchase.</p>

              <h3 className="text-xl font-semibold text-black mt-6 mb-3">4.2 Refund Limitations</h3>
              <p>Refunds will <strong>not</strong> be issued after the 7-day period has passed.</p>

              <h3 className="text-xl font-semibold text-black mt-6 mb-3">4.3 Refund Method</h3>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">5.1 No Guarantee of Suitability</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">5.2 User Responsibility</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">6.1 Maximum Liability</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">6.2 Indemnification</h3>
              ...
              <h3 className="text-xl font-semibold text-black mt-6 mb-3">8.1 Applicable Law</h3>
              <p>
                These Terms are governed by the laws of <strong>Canada</strong>, without regard to conflict-of-law rules.
              </p>

              <h3 className="text-xl font-semibold text-black mt-6 mb-3">8.2 Dispute Resolution</h3>
              <p>
